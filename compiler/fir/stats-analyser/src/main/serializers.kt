...
object UnitStatsSerializer : KSerializer<UnitStats> {
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor("org.jetbrains.kotlin.util.UnitStats") {
        ...
        element<Time?>("initStats")
        element<Time?>("analysisStats")
        element<Time?>("irGenerationStats")
        element<Time?>("irLoweringStats")
        element<Time?>("backendStats")

        element<SideStats?>("findJavaClassStats", isOptional = true)
        element<SideStats?>("findKotlinClassStats", isOptional = true)

        element<List<GarbageCollectionStats>>("gcStats", isOptional = true)
