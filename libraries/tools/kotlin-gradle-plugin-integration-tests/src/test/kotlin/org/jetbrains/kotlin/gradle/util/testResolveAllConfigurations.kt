...
private fun Project.registerResolveAllConfigurationsTask() {
    tasks.register(RESOLVE_ALL_CONFIGURATIONS_TASK_NAME) {
        ...
        it.inputs.property("projectPath", project.path)
        it.inputs.property("projectRootDir", project.rootDir)
        ...
        it.doFirst { task ->
            val projectRootDir = task.inputs.properties["projectRootDir"] as File
            val projectPath = task.inputs.properties["projectPath"] as String
