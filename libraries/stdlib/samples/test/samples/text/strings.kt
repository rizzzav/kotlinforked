...
class Strings {
    ...
    fun substringFromStartIndex() {
        ...
        assertFails { str.substring(6) } // startIndex exceeds the string length
    }
    ...
    fun substringByStartAndEndIndices() {
        ...
        assertFails { str.substring(0, 6) } // endIndex exceeds string length
        assertFails { str.substring(1, 0) } // endIndex is smaller than the startIndex
    }
